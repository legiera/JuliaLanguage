...
function calc_julia_main(h,w)
  ...
  tic()
  calc_julia!(julia_set, xrange, yrange, height=h, width_end=w)
  timer = toc()
...
my_time_0 = calc_julia_main(2000,2000)
addprocs(1)
my_time_1 = calc_julia_main(2000,2000)
addprocs(1)
my_time_2 = calc_julia_main(2000,2000)
addprocs(1)
my_time_3 = calc_julia_main(2000,2000)
addprocs(1)
my_time_4 = calc_julia_main(2000,2000)
